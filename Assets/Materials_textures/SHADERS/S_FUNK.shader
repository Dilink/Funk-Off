...
Shader "FUNK_SHADER"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			Input i = s.SurfInput;
			half4 c = 0;
			float mulTime177 = _Time.y * 5.607477;
			float4 temp_cast_2 = (( (0.95 + (abs( sin( mulTime177 ) ) - 0.0) * (1.05 - 0.95) / (1.0 - 0.0)) * _TRAME_LVL )).xxxx;
			...
			#endif
			float4 temp_cast_4 = (( (0.95 + (abs( sin( mulTime177 ) ) - 0.0) * (1.05 - 0.95) / (1.0 - 0.0)) * _TRAME_LVL )).xxxx;
...
/*ASEBEGIN
Version=16100
0;0;1920;1019;1416.86;405.4045;1;True;True
...
Node;AmplifyShaderEditor.SimpleTimeNode;177;-711.0668,-35.85146;Float;False;1;0;FLOAT;5.607477;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;179;-416.9134,-26.06203;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;180;-241.6388,-10.16552;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.95;False;4;FLOAT;1.05;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-1057.428,191.2318;Float;False;Property;_TRAME_LVL;TRAME_LVL;1;0;Create;True;0;0;False;0;0.21;0.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;181;58.90905,117.448;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;120;261.5392,548.9557;Float;False;Property;_SHADOW_COLOR;SHADOW_COLOR;8;0;Create;True;0;0;False;0;0.1373863,0.122241,0.3867925,1;0.2830189,0.137282,0.1081346,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;181;1;86;0
WireConnection;129;0;84;0
WireConnection;129;1;88;0
WireConnection;85;0;181;0
...
ASEEND*/
//CHKSM=95F5A5831C8E9B7314EF4422BE7077186D283175