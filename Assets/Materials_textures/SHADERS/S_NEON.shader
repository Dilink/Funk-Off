...
Shader "S_NEON"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color11 = IsGammaSpace() ? float4(0.3160377,1,0.9618113,0) : float4(0.08143245,1,0.9153157,0);
			float2 panner2 = ( _Time.y * _Speed + i.uv_texcoord);
			float4 tex2DNode1 = tex2D( _T_NEON, panner2 );
			float4 lerpResult14 = lerp( color13 , ( color11 * ( 4.12 * tex2DNode1 ) ) , tex2DNode1);
...
/*ASEBEGIN
Version=16100
0;0;1920;1019;1793.04;1309.639;2.405406;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-122.8219,-363.8151;Float;False;Constant;_Float1;Float 1;1;0;Create;True;0;0;False;0;4.12;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-19.34073,-215.1986;Float;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;11;137.4882,-369.6138;Float;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;False;0;0.3160377,1,0.9618113,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;17;-9.329468,109.3031;Float;False;Property;_Keyword0;Keyword 0;2;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=DA066D254504A2802CF71156DD7C256675540E41